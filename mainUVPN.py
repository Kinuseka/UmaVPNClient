...
import sys, os
import time
from lib.tools import pinger, handle_ping
...
class GUI(QWidget):
    def __init__(self, parent) -> None:
        ...
        gridLayout.addWidget(pinglayout, 2,0,1,1)
        #
    ...
    def load_title(self):
        ...
        github_button.setIcon(QIcon(os.path.join('res','github-mark-white.png')))
        github_button.setIconSize(QtCore.QSize(16,16))
        github_button.setMaximumWidth(16)
        github_button.enterEvent = (lambda event: self._set_icon(github_button,os.path.join('res','github-mark.png')))
        github_button.leaveEvent = (lambda event: self._set_icon(github_button,os.path.join('res','github-mark-white.png')))
